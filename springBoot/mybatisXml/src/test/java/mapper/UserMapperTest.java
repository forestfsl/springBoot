...
public class UserMapperTest {
    ...
    public void testInsert() throws Exception {
        UserMapper.insert(new UserEntiy("dd", "a123456", UserSexEnum.MAN));
        UserMapper.insert(new UserEntiy("ee", "b123456", UserSexEnum.WOMAN));
        UserMapper.insert(new UserEntiy("ff", "b123456", UserSexEnum.WOMAN));
